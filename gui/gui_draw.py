...
class GUIDraw(QWidget):
    ...
    def init_color(self):
        ...
        print('gui_draw init_color', self.color)

    # 여기서 겂이 변경되고 받아온다.
    def change_color(self, pos=None):
        print('gui_draw change_color', pos)
        if pos is not None:
    ...
    def calibrate_color(self, c, pos):
        ...
        print('calibrate_color red', c.red())
    ...
    def set_color(self, c_rgb):
        print('gamut 눌렀음')
        print('gui_draw set_color', c_rgb)
    ...
    def mousePressEvent(self, event):
        print('gui_draw mouse press', event.pos())
